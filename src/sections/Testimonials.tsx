...
export const TestimonialsSection = () => {
  ...
  <section id="testimonials" className="py-16 lg:py-24">
    ...
    />
{/* Wrapper fot the testimonial card */}
          ...
          <Fragment key={index}>
            {testimonials.map(testimonial => (
              ...
              <div className="flex gap-4 items-center">
                <div className="size-14 bg-white/80 inline-flex items-center justify-center rounded-full flex-shrink-0">
              ...
              <div className="text-sm text-white/50">{testimonial.position}
              </div>
              </div>
